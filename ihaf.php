<?php
/**
* Plugin Name: Javascript Find Replace
* GitHub Plugin URI: coolcourd/javacript-find-replace
* GitHub Plugin URI: https://github.com/coolcourd/javacript-find-replace
* Version: 1.0
* Author: Courd
